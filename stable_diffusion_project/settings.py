...
SECRET_KEY = 'django-insecure-^h$wy7tv7uz0pddrf(s_a*15w^c6b_ibc^@+edfk-_+ul8b=7^'
...
ROOT_URLCONF = 'stable_diffusion_project.urls'
...
WSGI_APPLICATION = 'stable_diffusion_project.wsgi.application'
...
# Add this to your settings for media files
MEDIA_URL = '/media/'
